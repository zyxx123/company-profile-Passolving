    ...
    <div class="container mx-auto px-6 max-w-[1320px]">
        <div class="flex items-center justify-between">
            ...
            <a href="/" wire:navigate class="flex flex-col shrink-0">
                <img src="{{ asset('logo-white-trimmed.png') }}" :src="scrolled ? '{{ asset('logo-black-trimmed.png') }}' : '{{ asset('logo-white-trimmed.png') }}'" alt="Passolving Logo" class="h-8 md:h-10 w-auto object-contain">
            </a>
