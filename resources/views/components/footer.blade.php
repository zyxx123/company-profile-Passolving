        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-10">
            ...
            <div class="flex flex-col">
                ...
                <div class="flex items-center gap-4 flex-wrap">
                    <a href="https://www.linkedin.com/company/passolving/" target="_blank" class="w-11 h-11 rounded-lg bg-white/10 flex items-center justify-center hover:bg-cta hover:text-primary transition-all">
                        <x-icon name="lucide-linkedin" class="w-5 h-5" />
                    </a>
                    <a href="https://www.instagram.com/passolving?utm_source=ig_web_button_share_sheet&igsh=ZDNlZDc0MzIxNw==" target="_blank" class="w-11 h-11 rounded-lg bg-white/10 flex items-center justify-center hover:bg-cta hover:text-primary transition-all">
                        <x-icon name="lucide-instagram" class="w-5 h-5" />
                    </a>
                    <a href="https://www.youtube.com/@passolving9836" target="_blank" class="w-11 h-11 rounded-lg bg-white/10 flex items-center justify-center hover:bg-cta hover:text-primary transition-all">
                        <x-icon name="lucide-youtube" class="w-5 h-5" />
                    </a>
                    <a href="https://facebook.com/kita.passolving.7" target="_blank" class="w-11 h-11 rounded-lg bg-white/10 flex items-center justify-center hover:bg-cta hover:text-primary transition-all">
                        <x-icon name="lucide-facebook" class="w-5 h-5" />
                    </a>
                    <a href="https://www.threads.net/@passolving" target="_blank" class="w-11 h-11 rounded-lg bg-white/10 flex items-center justify-center hover:bg-cta hover:text-primary transition-all">
            ...
            <div>
                ...
                <ul class="space-y-4">
                    <li class="flex items-start gap-3">
                        ...
                        <a href="https://wa.me/628979515205" target="_blank" class="text-primary-dark/80 hover:text-cta transition-colors">+62 897 9515 205</a>
                    </li>
                    <li class="flex items-start gap-3">
                        <x-icon name="lucide-mail" class="w-5 h-5 text-cta shrink-0 mt-0.5" />
                        <a href="mailto:bersama@passolving.com" class="text-primary-dark/80 hover:text-cta transition-colors">bersama@passolving.com</a>
                    </li>
                    <li class="flex items-start gap-3">
                        <x-icon name="lucide-map-pin" class="w-5 h-5 text-cta shrink-0 mt-0.5" />
                        <span class="text-primary-dark/80">Jl. P.P.A No.24, RT.5/RW.4, Ceger<br>Kec. Cipayung, Jakarta Timur 13820</span>
                    </li>
                </ul>
            </div>
