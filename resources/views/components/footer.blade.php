<footer class="bg-primary pt-12 pb-6 text-primary-dark text-sm">
    <div class="container mx-auto px-6 max-w-[1320px]">
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-10">
            ...
            <div class="flex flex-col">
                ...
                <p class="text-primary-dark/80 leading-relaxed mb-6 pr-4">
                    {{ \App\Models\SiteSetting::get('tagline', 'Partner strategis Anda dalam mewujudkan kelincahan (agility) dan efektivitas tim yang berkelanjutan di era transformasi.') }}
                </p>
                <div class="flex items-center gap-4 flex-wrap">
                    <a href="{{ \App\Models\SiteSetting::get('linkedin_url', 'https://www.linkedin.com/company/passolving/') }}" target="_blank" class="w-11 h-11 rounded-lg bg-white/10 flex items-center justify-center hover:bg-cta hover:text-primary transition-all">
                        <x-icon name="lucide-linkedin" class="w-5 h-5" />
                    </a>
                    <a href="{{ \App\Models\SiteSetting::get('instagram_url', 'https://www.instagram.com/passolving') }}" target="_blank" class="w-11 h-11 rounded-lg bg-white/10 flex items-center justify-center hover:bg-cta hover:text-primary transition-all">
                        <x-icon name="lucide-instagram" class="w-5 h-5" />
                    </a>
                    <a href="{{ \App\Models\SiteSetting::get('youtube_url', 'https://www.youtube.com/@passolving9836') }}" target="_blank" class="w-11 h-11 rounded-lg bg-white/10 flex items-center justify-center hover:bg-cta hover:text-primary transition-all">
                        <x-icon name="lucide-youtube" class="w-5 h-5" />
                    </a>
                    <a href="{{ \App\Models\SiteSetting::get('facebook_url', 'https://facebook.com/kita.passolving.7') }}" target="_blank" class="w-11 h-11 rounded-lg bg-white/10 flex items-center justify-center hover:bg-cta hover:text-primary transition-all">
                        <x-icon name="lucide-facebook" class="w-5 h-5" />
                    </a>
                    <a href="{{ \App\Models\SiteSetting::get('threads_url', 'https://www.threads.net/@passolving') }}" target="_blank" class="w-11 h-11 rounded-lg bg-white/10 flex items-center justify-center hover:bg-cta hover:text-primary transition-all">
            ...
            <!-- Column 4: Contact -->
            <div>
                <h4 class="font-bold text-base mb-4 text-primary-dark/90">Hubungi Kami</h4>
                <ul class="space-y-4">
                    <li class="flex items-start gap-3">
                        <x-icon name="lucide-phone" class="w-5 h-5 text-cta shrink-0 mt-0.5" />
                        <a href="https://wa.me/{{ preg_replace('/[^0-9]/', '', \App\Models\SiteSetting::get('phone', '628979515205')) }}" target="_blank" class="text-primary-dark/80 hover:text-cta transition-colors">{{ \App\Models\SiteSetting::get('phone', '+62 897 9515 205') }}</a>
                    </li>
                    <li class="flex items-start gap-3">
                        <x-icon name="lucide-mail" class="w-5 h-5 text-cta shrink-0 mt-0.5" />
                        <a href="mailto:{{ \App\Models\SiteSetting::get('email', 'bersama@passolving.com') }}" class="text-primary-dark/80 hover:text-cta transition-colors">{{ \App\Models\SiteSetting::get('email', 'bersama@passolving.com') }}</a>
                    </li>
                    <li class="flex items-start gap-3">
                        <x-icon name="lucide-map-pin" class="w-5 h-5 text-cta shrink-0 mt-0.5" />
                        <span class="text-primary-dark/80">{!! nl2br(e(\App\Models\SiteSetting::get('address', 'Jl. P.P.A No.24, RT.5/RW.4, Ceger, Kec. Cipayung, Jakarta Timur 13820'))) !!}</span>
                    </li>
                </ul>
            </div>
        ...
        <div class="pt-6 border-t border-white/10 flex flex-col md:flex-row justify-between items-center gap-4 text-xs">
            ...
            <div class="flex items-center gap-6">
                <a href="#" class="text-primary-dark/60 hover:text-primary-dark transition-colors">Kebijakan Privasi</a>
                <a href="#" class="text-primary-dark/60 hover:text-primary-dark transition-colors">Syarat & Ketentuan</a>
            </div>
        </div>
    </div>
</footer>
