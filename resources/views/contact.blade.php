                        ...
                        <div class="relative z-10">
                            ...
                            <div class="space-y-10">
                                ...
                                <div class="flex items-start gap-6 group">
                                    <div class="w-16 h-16 rounded-2xl bg-white/10 flex items-center justify-center shrink-0 border border-white/20 group-hover:bg-primary group-hover:border-transparent transition-all duration-300">
                                    ...
                                    <div>
                                        <h4 class="text-xl font-bold text-white mb-2 group-hover:text-primary transition-colors">Phone</h4>
                                ...
                                <!-- Instagram -->
                                <div class="flex items-start gap-6 group">
                                    <div class="w-16 h-16 rounded-2xl bg-white/10 flex items-center justify-center shrink-0 border border-white/20 group-hover:bg-primary-dark group-hover:border-transparent transition-all duration-300">
                                        <svg class="w-8 h-8 text-white group-hover:text-secondary transition-colors" fill="none" stroke="currentColor" viewBox="0 0 24 24"><rect width="20" height="20" x="2" y="2" rx="5" ry="5"></rect><path d="M16 11.37A4 4 0 1 1 12.63 8 4 4 0 0 1 16 11.37z"></path><line x1="17.5" x2="17.51" y1="6.5" y2="6.5"></line></svg>
                                    </div>
                                    <div>
                                        <h4 class="text-xl font-bold text-white mb-2 group-hover:text-primary-dark transition-colors">Instagram</h4>
                                        <p class="text-slate-400 leading-relaxed">
                                            @passolving
                                        </p>
                                    </div>
