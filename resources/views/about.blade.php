                    ...
                    <div class="relative z-10">
                        ...
                        <div class="space-y-8">
                            <div class="flex gap-6 group">
                                <div class="w-12 h-12 bg-white/5 flex items-center justify-center shrink-0 border border-white/20 text-xl font-black text-primary group-hover:bg-primary group-hover:text-secondary group-hover:border-primary transition-all transform group-hover:rotate-12">1</div>
                                <div>
                            ...
                            <div class="flex gap-6 group">
                                <div class="w-12 h-12 bg-white/5 flex items-center justify-center shrink-0 border border-white/20 text-xl font-black text-primary group-hover:bg-primary group-hover:text-secondary group-hover:border-primary transition-all transform group-hover:rotate-12">2</div>
                                <div>
                            ...
                            <div class="flex gap-6 group">
                                <div class="w-12 h-12 bg-white/5 flex items-center justify-center shrink-0 border border-white/20 text-xl font-black text-primary group-hover:bg-primary group-hover:text-secondary group-hover:border-primary transition-all transform group-hover:rotate-12">3</div>
                                <div>
                ...
                <div class="grid md:grid-cols-3 gap-0 border-t border-l border-slate-200 bg-white">
                    ...
                    <div class="p-10 border-b border-r border-slate-200 hover:bg-secondary hover:text-white transition-colors duration-300 group cursor-pointer relative overflow-hidden" data-aos="fade-up" data-aos-duration="500" data-aos-delay="0">
                        ...
                        <div class="relative z-10 mt-auto">
                            <p class="font-black text-secondary text-xs tracking-widest uppercase group-hover:text-primary transition-colors">{{ __('Manager Retail Chain') }}</p>
                    ...
                    <div class="p-10 border-b border-r border-slate-200 hover:bg-secondary hover:text-white transition-colors duration-300 group cursor-pointer relative overflow-hidden" data-aos="fade-up" data-aos-duration="500" data-aos-delay="100">
                        ...
                        <div class="relative z-10 mt-auto">
                            <p class="font-black text-secondary text-xs tracking-widest uppercase group-hover:text-primary transition-colors">{{ __('Founder Food Manufacturer') }}</p>
                    ...
                    <div class="p-10 border-b border-r border-slate-200 hover:bg-secondary hover:text-white transition-colors duration-300 group cursor-pointer relative overflow-hidden" data-aos="fade-up" data-aos-duration="500" data-aos-delay="200">
                        ...
                        <div class="relative z-10 mt-auto">
                            <p class="font-black text-secondary text-xs tracking-widest uppercase group-hover:text-primary transition-colors">{{ __('Founder Beauty Clinic') }}</p>
                            <p class="text-slate-400 group-hover:text-slate-500 text-sm mt-1">{{ __('Indonesia') }}</p>
                        </div>
                    </div>
                    ...
                    <div class="p-10 border-b border-r border-slate-200 hover:bg-secondary hover:text-white transition-colors duration-300 group cursor-pointer relative overflow-hidden" data-aos="fade-up" data-aos-duration="500" data-aos-delay="0">
                        ...
                        <div class="relative z-10 mt-auto">
                            <p class="font-black text-secondary text-xs tracking-widest uppercase group-hover:text-primary transition-colors">{{ __('Founder Integrated Farm') }}</p>
                            <p class="text-slate-400 group-hover:text-slate-500 text-sm mt-1">{{ __('Indonesia') }}</p>
                        </div>
                    </div>
                    ...
                    <div class="p-10 border-b border-r border-slate-200 hover:bg-secondary hover:text-white transition-colors duration-300 group cursor-pointer relative overflow-hidden" data-aos="fade-up" data-aos-duration="500" data-aos-delay="100">
                        ...
                        <div class="relative z-10 mt-auto">
                            <p class="font-black text-secondary text-xs tracking-widest uppercase group-hover:text-primary transition-colors">{{ __('COO Agroindustry') }}</p>
                            <p class="text-slate-400 group-hover:text-slate-500 text-sm mt-1">{{ __('Indonesia') }}</p>
                        </div>
                    </div>
                    ...
                    <div class="p-10 border-b border-r border-slate-200 hover:bg-secondary hover:text-white transition-colors duration-300 group cursor-pointer relative overflow-hidden" data-aos="fade-up" data-aos-duration="500" data-aos-delay="200">
                        ...
                        <div class="relative z-10 mt-auto">
                            <p class="font-black text-secondary text-xs tracking-widest uppercase group-hover:text-primary transition-colors">{{ __('Perusahaan Telekomunikasi') }}</p>
                        </div>
                    </div>
                </div>
            </div>
