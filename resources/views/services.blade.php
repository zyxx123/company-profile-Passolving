        ...
        <div class="container mx-auto px-6 max-w-7xl relative z-10">
                    ...
                    <div class="relative z-10 text-center max-w-4xl mx-auto">
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-0 text-left relative z-20 border-t border-l border-white/10">
                            <div class="bg-secondary p-8 border-b border-r border-white/10 hover:bg-primary group/card transition-colors duration-300">
                                <h4 class="text-xl font-black text-white mb-2 group-hover/card:text-accent transition-colors">{{ __('1. Transformation Agility') }}</h4>
                                <p class="text-white/80 font-medium group-hover/card:text-accent/80">{{ __('Kepemimpinan, Budaya & Arah Strategis') }}</p>
                            </div>
                            <div class="bg-secondary p-8 border-b border-r border-white/10 hover:bg-primary group/card transition-colors duration-300">
                                <h4 class="text-xl font-black text-white mb-2 group-hover/card:text-accent transition-colors">{{ __('2. R&D Agility') }}</h4>
                                <p class="text-white/80 font-medium group-hover/card:text-accent/80">{{ __('Inovasi, Pelanggan & Perbaikan Berkelanjutan') }}</p>
                            </div>
                            <div class="bg-secondary p-8 border-b border-r border-white/10 hover:bg-primary group/card transition-colors duration-300">
                                <h4 class="text-xl font-black text-white mb-2 group-hover/card:text-accent transition-colors">{{ __('3. Strategy Agility') }}</h4>
                                <p class="text-white/80 font-medium group-hover/card:text-accent/80">{{ __('Penyelarasan Enterprise & Tata Kelola') }}</p>
                            </div>
                            <div class="bg-secondary p-8 border-b border-r border-white/10 hover:bg-primary group/card transition-colors duration-300">
                                <h4 class="text-xl font-black text-white mb-2 group-hover/card:text-accent transition-colors">{{ __('4. Operational Agility') }}</h4>
                                <p class="text-white/80 font-medium group-hover/card:text-accent/80">{{ __('Kesiapan Tim & Praktik Operasional') }}</p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="mb-32">
                <div class="text-center mb-16" data-aos="fade-up" data-aos-duration="700">
                    ...
                    <h3 class="text-3xl md:text-4xl lg:text-5xl font-black text-accent tracking-tight mb-4 md:mb-6 uppercase">{{ __('Training Methodology') }}</h3>
                ...
                <div class="grid md:grid-cols-2 gap-0 max-w-5xl mx-auto mb-12 md:mb-16 border-2 border-slate-200">
                    ...
                    <div class="bg-white p-8 md:p-12 border-r border-slate-200 hover:bg-secondary hover:text-white transition-colors duration-500 group relative overflow-hidden" data-aos="fade-right" data-aos-duration="700">
                        ...
                        <h4 class="text-2xl font-black text-accent mb-4 relative z-10 group-hover:text-primary transition-colors tracking-widest uppercase">ACTIVITY</h4>
                    ...
                    <div class="bg-white p-8 md:p-12 hover:bg-primary transition-colors duration-500 group relative overflow-hidden" data-aos="fade-left" data-aos-duration="700" data-aos-delay="150">
                        <div class="text-6xl font-black text-accent mb-6 transform group-hover:scale-110 group-hover:translate-x-2 transition-transform duration-500 relative z-10">20%</div>
                        <h4 class="text-2xl font-black text-accent mb-4 relative z-10 tracking-widest uppercase">INSIGHT</h4>
                        <p class="text-slate-600 group-hover:text-accent/80 text-lg leading-relaxed relative z-10 font-medium">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-0 border-t border-l border-slate-200">
                    <div class="bg-white p-8 border-b border-r border-slate-200 hover:bg-slate-50 transition-colors group" data-aos="fade-up" data-aos-duration="500" data-aos-delay="0">
                        ...
                        <h5 class="text-xl font-black text-accent mb-3 uppercase">{{ __('Problem Identification') }}</h5>
                    ...
                    <div class="bg-white p-8 border-b border-r border-slate-200 hover:bg-slate-50 transition-colors group" data-aos="fade-up" data-aos-duration="500" data-aos-delay="100">
                        ...
                        <h5 class="text-xl font-black text-accent mb-3 uppercase">{{ __('Action Development') }}</h5>
                    ...
                    <div class="bg-white p-8 border-b border-r border-slate-200 hover:bg-slate-50 transition-colors group" data-aos="fade-up" data-aos-duration="500" data-aos-delay="200">
                        ...
                        <h5 class="text-xl font-black text-accent mb-3 uppercase">{{ __('Program Implementation') }}</h5>
                    ...
                    <div class="bg-white p-8 border-b border-r border-slate-200 hover:bg-slate-50 transition-colors group" data-aos="fade-up" data-aos-duration="500" data-aos-delay="300">
                        ...
                        <h5 class="text-xl font-black text-accent mb-3 uppercase">{{ __('Evaluation') }}</h5>
            ...
            <div class="mb-32">
                <div class="bg-white border-4 border-secondary p-8 md:p-12 lg:p-20 relative overflow-hidden text-center max-w-5xl mx-auto shadow-2xl group" data-aos="zoom-in" data-aos-duration="700">
                    ...
                    <h3 class="text-2xl md:text-4xl lg:text-5xl xl:text-6xl font-black text-accent mb-4 tracking-tight">LEGO® Serious Play®</h3>
            ...
            <div class="mb-32">
                <div class="text-center mb-16" data-aos="fade-up" data-aos-duration="700">
                    ...
                    <h3 class="text-3xl md:text-4xl lg:text-5xl font-black text-accent tracking-tight mb-4 md:mb-6 uppercase">{{ __('The 4S Framework') }}</h3>
                </div>
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-0 border-t border-l border-slate-200">
                    <div class="bg-white p-8 border-b border-r border-slate-200 hover:bg-secondary hover:text-white transition-colors duration-300 group" data-aos="fade-up" data-aos-duration="500" data-aos-delay="0">
                        <h4 class="text-2xl font-black text-accent mb-4 group-hover:text-primary transition-colors">SCAN</h4>
                    ...
                    <div class="bg-white p-8 border-b border-r border-slate-200 hover:bg-secondary hover:text-white transition-colors duration-300 group" data-aos="fade-up" data-aos-duration="500" data-aos-delay="100">
                        <h4 class="text-2xl font-black text-accent mb-4 group-hover:text-primary transition-colors">SHIFT</h4>
                    ...
                    <div class="bg-white p-8 border-b border-r border-slate-200 hover:bg-secondary hover:text-white transition-colors duration-300 group" data-aos="fade-up" data-aos-duration="500" data-aos-delay="200">
                        <h4 class="text-2xl font-black text-accent mb-4 group-hover:text-primary transition-colors">SCALE</h4>
                    ...
                    <div class="bg-white p-8 border-b border-r border-slate-200 hover:bg-secondary hover:text-white transition-colors duration-300 group" data-aos="fade-up" data-aos-duration="500" data-aos-delay="300">
                        <h4 class="text-2xl font-black text-accent mb-4 group-hover:text-primary transition-colors">SCRIBE</h4>
